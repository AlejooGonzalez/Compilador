...
public class Firsts {
    ...
    public Firsts() {
        ...
        firsts.put("Sentencia", new ArrayList<>(concat(List.of("pnt_puntoYComa"), firsts.get("AsignacionLlamada"), firsts.get("VarLocal"), firsts.get("Return"), firsts.get("If"), firsts.get("While"), firsts.get("Bloque"))));
    ...
    private List<String> concat(List<String> a, List<String> b, List<String> c, List<String> d, List<String> e, List<String> f, List<String> g) {
        List<String> returnList = new ArrayList<>();
        if (a != null) returnList.addAll(a);
        if (b != null) returnList.addAll(b);
        if (c != null) returnList.addAll(c);
